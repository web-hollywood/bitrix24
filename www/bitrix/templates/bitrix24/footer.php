					...
					<td class="bx-layout-inner-center">
						<div id="footer">
							<span id="copyright">
								...
								?>
									<a class="b24-web-form-popup-btn-57 footer-discuss-link" onclick="B24.showPartnerOrderForm(<?=CUtil::PhpToJSObject($orderParams)?>);"><?=GetMessage("BITRIX24_ORDER_PARTNER")?></a>
								<?else:?>
