(function() {
	...
	BX.Disk.Model.ExternalLink.Input = function(parameters)
	{
		...
		this.templateId = 'external-link-setting-input';
	...
	BX.Disk.Model.ExternalLink.Input.prototype =
	{
		...
		{
			var block = this.getEntity(this.getContainer(), 'external-link-block');
			if (block.classList.contains('disk-detail-sidebar-public-link-block-show') || block.classList.contains('disk-public-link-block-show'))
			{
