...
<div class="intranet-license-restriction-container">
	...
	<div class="intranet-license-restriction-desc">
		<div class="intranet-license-restriction-desc-item"><?=GetMessage("LICENSE_RESTR_TEXT")?></div>
	</div>
</div>
<div class="intranet-license-restriction-container">
	...
	<div class="intranet-license-restriction-info"><?=GetMessage("LICENSE_RESTR_TEXT3", array("#NUM#" => $arResult["NUM_ALL_USERS"]))?></div>
</div>
