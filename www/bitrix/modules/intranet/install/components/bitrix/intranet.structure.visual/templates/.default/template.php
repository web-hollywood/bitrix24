...
?>
	...
	<div class="structure-boss-block" data-role="department_head" data-user="<?=$arEntry['UF_HEAD']?>" data-dpt="<?=$arEntry['ID']?>" bx-tooltip-user-id="<?=($arParams['USE_USER_LINK'] == 'Y' ? $arEntry['UF_HEAD'] : '')?>" bx-tooltip-classname="intrantet-user-selector-tooltip">
<?
		if ($bHasHead):
