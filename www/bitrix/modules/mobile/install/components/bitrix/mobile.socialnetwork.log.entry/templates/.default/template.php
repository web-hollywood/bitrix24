				...
				if (is_array($arEvent["COMMENTS"]))
				{
					foreach($arEvent["COMMENTS"] as $arComment)
					{
						...
						$records[$commentId] = array(
							...
							"RATING_VOTE_ID" => 'BLOG_COMMENT_'.$res['ID'].'-'.(time()+rand(0, 1000))
						);
						...
						{
							$voteId = $arComment["EVENT"]["RATING_TYPE_ID"].'_'.$arComment["EVENT"]["RATING_ENTITY_ID"].'-'.(time()+rand(0, 1000));

							$records[$commentId]["RATING_VOTE_ID"] = $voteId;
							$records[$commentId]["RATING_USER_HAS_VOTED"] = $arResult["RATING_COMMENTS"][$arComment["EVENT"]["RATING_ENTITY_ID"]]["USER_HAS_VOTED"];
							$records[$commentId]["RATING_USER_REACTION"] = $arResult["RATING_COMMENTS"][$arComment["EVENT"]["RATING_ENTITY_ID"]]["USER_REACTION"];
						}
