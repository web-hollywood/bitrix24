	...
	if ($iVersion >= 2)
	{
		...
		if (!empty($arContact['TYPE_ID']))
		{
			$fields .= '<span class="field-row">
				<span class="field-name">'.GetMessage('CRM_COLUMN_TYPE').'</span>: <span class="field-value"><span class="fields enumeration">'.$arResult['TYPE_LIST'][$arContact['TYPE_ID']].'</span></span>
			</span>';
		}
		$fields .= '<span class="field-row">
			<span class="field-name">'.GetMessage('CRM_COLUMN_DATE_MODIFY').'</span>: <span class="field-value"><span class="fields enumeration">'.FormatDate('x', MakeTimeStamp($arContact['DATE_MODIFY']), (time() + CTimeZone::GetOffset())).'</span></span>
		</span>';
...
//		$fields .= '<span class="field-row">'.GetMessage('CRM_SECTION_CONTACT_INFO').'</span>';
		...
		{
			$fields .= '<span class="field-row">
				<span class="field-name">'.GetMessage('CRM_COLUMN_COMPANY_TITLE').'</span>: <span class="field-value"><a href="'.$arContact['PATH_TO_COMPANY_SHOW'].'" target="_blank">'.htmlspecialcharsbx($arContact['COMPANY_TITLE']).'</a></span>
			</span>';
		}
