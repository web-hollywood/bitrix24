...
<div id="bx-crm-volume-main-block" class="crm-volume-wrap <? if ($arResult['QUEUE_RUNNING']): ?>crm-volume-running<? endif; ?>">
	<div id="bx-crm-volume-stepper" class="crm-volume-stepper bx-ui-crm-volume-stepper" <? if ($arResult['HAS_WORKER_IN_PROCESS'] !== true || $arResult["RELOAD"]): ?>style="display: none"<? endif; ?>>
		<?
		if ($arResult['HAS_WORKER_IN_PROCESS'] && $arResult["RELOAD"] !== true)
		{
