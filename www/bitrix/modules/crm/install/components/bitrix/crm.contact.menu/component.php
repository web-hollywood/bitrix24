...
if($arParams['TYPE'] === 'details')
{
	...
	$documentLinks = \Bitrix\Crm\Integration\DocumentGeneratorManager::getInstance()->getPreviewList(\Bitrix\Crm\Integration\DocumentGenerator\DataProvider\Contact::class, $arParams['ELEMENT_ID']);
