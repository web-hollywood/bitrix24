...
<script type="text/javascript">
	...
	BX.ready(
		function()
		{
			BX.addCustomEvent(window, "onLocalStorageSet", BX.delegate(function(params){

				var key = BX.prop.getString(params, "key", "");

				if(key !== "onCrmEntityCreate" && key !== "onCrmEntityUpdate" && key !== "onCrmEntityDelete")
				{
					return;
				}
				...
				if(BX.prop.getString(eventData, "entityTypeName", "") === 'ORDER')
				{
					window.setTimeout(
