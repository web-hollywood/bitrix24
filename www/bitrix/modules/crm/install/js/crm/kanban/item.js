...
BX.CRM.Kanban.Item.prototype = {
						...
						BX.create("div", {
							...
							children: [
								...
								BX.create("div", {
									...
									text: BX.message("CRM_KANBAN_EMPTY_CARD_CT_TEXT")
								})
							]
						}),
						BX.create("div", {
	...
	createLayout: function()
	{
		...
		this.container = BX.create("div", {
			...
			events: {
				click: function(e)
				{
					...
					this.checked ? this.unSelectItem() : this.selectItem();
				}.bind(this),
				dblclick: function()
				{
		...
		this.repeated = BX.create("div", {
			...
			text: BX.message("CRM_KANBAN_REPEATED_LEAD")
		});

		this.options.data.return ? this.container.appendChild(this.repeated) : null;
