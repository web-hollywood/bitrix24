...
<div class="imconnector-field-box">
	...
	<div class="imconnector-field-button-box">
		<a onclick="top.BX.Helper.show('<?=Loc::getMessage('IMCONNECTOR_COMPONENT_TELEGRAMBOT_INFO_CREATE_CONNECT_ID')?>');"
		...
		<a onclick="top.BX.Helper.show('<?=Loc::getMessage('IMCONNECTOR_COMPONENT_TELEGRAMBOT_INFO_CONNECT_CONNECT_ID')?>');"
