		...
		<div class="transformer-uf-file-loader-container">
			...
			<div class="transformer-uf-file-loader-inner">
				<svg class="transformer-uf-file-circular" viewBox="25 25 50 50">
					<circle class="transformer-uf-file-path" cx="50" cy="50" r="20" fill="none" stroke-miterlimit="10"/>
					<circle class="transformer-uf-file-inner-path" cx="50" cy="50" r="20" fill="none" stroke-miterlimit="10"/>
				</svg>
