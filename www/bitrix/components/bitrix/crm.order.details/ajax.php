...
final class AjaxProcessor extends \Bitrix\Crm\Order\AjaxProcessor
{
	...
	protected function setPaymentPaidFieldAction()
	{
		...
		if($paymentObj->getField('PAID') != $paid && $paymentObj->getField('IS_RETURN') == 'Y')
		{
			$setResult = $paymentObj->setReturn('N');
			...
			[
				...
				'acceptableErrorCodes' =>
					[
						...
						"SALE_BASKET_AVAILABLE_QUANTITY", "SALE_BASKET_ITEM_WRONG_AVAILABLE_QUANTITY",
