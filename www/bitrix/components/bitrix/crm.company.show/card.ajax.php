	...
	if ($iVersion >= 2)
	{
		...
		if (!empty($arCompany['COMPANY_TYPE']))
		{
			$fields .= '<span class="field-row">
				<span class="field-name">'.GetMessage('CRM_COLUMN_COMPANY_TYPE').'</span>: <span class="field-value"><span class="fields enumeration">'.$arResult['COMPANY_TYPE_LIST'][$arCompany['COMPANY_TYPE']].'</span></span>
			</span>';
		}
		if (!empty($arCompany['EMPLOYEES']))
		{
			$fields .= '<span class="field-row">
				<span class="field-name">'.GetMessage('CRM_COLUMN_EMPLOYEES').'</span>: <span class="field-value"><span class="fields enumeration">'.$arResult['EMPLOYEES_LIST'][$arCompany['EMPLOYEES']].'</span></span>
			</span>';
		}
		$fields .= '<span class="field-row">
			<span class="field-name">'.GetMessage('CRM_COLUMN_DATE_MODIFY').'</span>: <span class="field-value"><span class="fields enumeration">'.FormatDate('x', MakeTimeStamp($arCompany['DATE_MODIFY']), (time() + CTimeZone::GetOffset())).'</span></span>
		</span>';

//		$fields .= '<span class="field-row">'.GetMessage('CRM_SECTION_COMPANY_INFO').'</span>';
		...
		{
			$fields .= '<span class="field-row">
				<span class="field-name">'.GetMessage('CRM_COLUMN_WEB').'</span>: <span class="field-value">'.$multiFieldHtml['WEB'].'</span>
			</span>';
		}
