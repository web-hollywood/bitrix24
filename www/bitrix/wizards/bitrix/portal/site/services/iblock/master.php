...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/master.xml";
$iblockCode = "master_".WIZARD_SITE_ID; 
$iblockType = "services";
...
{
	$rsIBlock = CIBlock::GetList(array(), array("CODE" => "master", "TYPE" => $iblockType));
	if ($arIBlock = $rsIBlock->Fetch())
	{
		$iblockID = $arIBlock["ID"]; 
	}
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/support.php", Array("MASTER_IBLOCK_ID" => $iblockID));
?>
