...
if($formID == false){
	$arForm = array(
		"NAME" => GetMessage("SERVICE_SUPPLIES_FORM_NAME"),
		"SID" => "OFFICE_SUPPLIES_" . WIZARD_SITE_ID,
		"C_SORT" => 200,
		"BUTTON" => GetMessage("SERVICE_SUPPLIES_FORM_BUTTON"),
		"DESCRIPTION" => "",
