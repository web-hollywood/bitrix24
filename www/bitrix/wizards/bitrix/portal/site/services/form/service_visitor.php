...
if($formID == false){
	$arForm = array(
		"NAME" => GetMessage("SERVICE_VISITOR_FORM_NAME"),
		"SID" => "VISITOR_ACCESS_" . WIZARD_SITE_ID,
		"C_SORT" => 200,
		"BUTTON" => GetMessage("SERVICE_VISITOR_FORM_BUTTON"),
		"DESCRIPTION" => "",
